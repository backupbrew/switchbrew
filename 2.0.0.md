The 2.0 release added the eShop functionality, the ability to add
...
**The following network features are now
available**
...
## Important Information for Switch Hackers

The Nintendo Switch **does not** lock regions of games. As such, there
is no reason to target this area when examing firmware.
