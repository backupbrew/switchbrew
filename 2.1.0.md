...
thrown when applications crash. Instead, qlaunch displays an error
message, without requiring a reboot. It appears
[2.0.0](2.0.0.md "wikilink") qlaunch already had the message string for
this, which is: "The software was closed because an error occurred."
