...
This also affects launching the WifiWebAuthApplet via eShop on pre-v3.0.
Error 2110-3400 is thrown while eShop is loading, with the conntest
domain setup to trigger the web-applet(originally launching eShop could
be used for triggering the WifiWebAuthApplet). System Settings will
still launch the web-applet after it displays the "Registration required
