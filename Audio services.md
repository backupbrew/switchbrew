...
buffer (**PcmDataOut**). Decodes the Opus source data to PCM and returns
output s32 **DecodedDataSize**, s32 **DecodedSampleCount**, and an u64.
...
The bool flag indicates whether or not a reset of the decoder context is
being requested.
