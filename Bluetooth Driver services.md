...
| 8                       | StartDiscovery                                                                              |
| 9                       | CancelDiscovery                                                                             |
| 10                      | [\#CreateBond](#CreateBond "wikilink")                                                      |
| 11                      | RemoveBond                                                                                  |
| 12                      | CancelBond                                                                                  |
| 13                      | PinReply                                                                                    |
| 14                      | SspReply                                                                                    |
...
| 21                      | HidSetReport                                                                                |
| 22                      | HidGetReport                                                                                |
| 23                      | [\#HidWakeController](#HidWakeController "wikilink")                                        |
...
| 52                      | \[5.0.0+\] [\#SetLeDefaultConnectionParameter](#SetLeDefaultConnectionParameter "wikilink") |
...
| 68 (\[5.0.0-5.0.2\] 67) | \[5.0.0+\] [\#LeClientDisconnect](#LeClientDisconnect "wikilink")                           |
...
| 74 (\[5.0.0-5.0.2\] 73) | \[5.0.0+\] [\#LeServerConnect](#LeServerConnect "wikilink")                                 |
...
Takes a total of 0x6-bytes of input and a type-0x19 input buffer, no
output.

\[9.0.0+\] Now only takes a total of 0xC-bytes of input without a
buffer, no output.
