...
| 0x02            | 0x24              | 0x3C000001 | E, 4              | SDCard Power (POW\_SD\_EN)                                                                          | Out       | [Filesystem services](Filesystem%20services.md "wikilink")                                           |
...
| 0x0B            | 0x97              | 0x3D000002 | S, 7              | CPU Fan Tachometer (FAN\_TACH)                                                                      | In        |                                                                                                      |
...
| 0x0D            | 0x05              | 0x39000401 | A, 5              | Fan Enable (normal) (VDD50A\_EN)                                                                    | Out       | [PTM services](PTM%20services.md "wikilink")                                                         |
...
| 0x2E            | 0x39              | 0x38000002 | H, 1              | WIFI\_RST\_PH1                                                                                      | Out       | [Wlan services](Wlan%20services.md "wikilink"), [PCIe services](PCIe%20services.md "wikilink")       |
...
| 0x36            | 0xE4              | 0x39000402 | CC, 4             | Fan Enable (high power) (VDD50B\_EN)                                                                | Out       | [PTM services](PTM%20services.md "wikilink")                                                         |
...
| 0x41            | 0x0C              | 0x04000401 | B, 4              | USB Root Port 2 Over Current (USB\_B2\_OC)                                                          | In        | (SDEV only)                                                                                          |
...
| 0x4B            | 0x42              | 0x3D000003 | I, 2              | FAN\_EN                                                                                             | Out       | (SDEV only)                                                                                          |
| 0x4C            | 0xE6              | 0x04000408 | CC, 6             | USB Root Port 1 Over Current (USB\_B1\_OC)                                                          | In        | (SDEV only)                                                                                          |
| \[2.0.0+\] 0x4D | 0xAC              | 0x3D000001 | V, 4              | PWM\_FAN                                                                                            | Out       | (SDEV only)                                                                                          |
...
| \[6.0.0+\] 0x59 | 0xBB              | 0x39000403 | X, 3              | VDD5V3\_EN                                                                                          |           |                                                                                                      |
