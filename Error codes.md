...
| 0xD801            | 108         | Invalid memory permissions.                                                                                                                                                          |
...
| 0x235202          | 4521        | Invalid NCA Key index                                                                                                                                                                |
...
| 0xE209            | 113         | ACID/ACI0 don't match for descriptor "ApplicationType"                                                                                                                               |
| 0xE409            | 114         | ACID/ACI0 don't match for descriptor "KernelReleaseVersion"                                                                                                                          |
| 0xE609            | 115         | ACID/ACI0 don't match for descriptor "HandleTableSize"                                                                                                                               |
| 0xE809            | 116         | ACID/ACI0 don't match for descriptor "DebugFlags"                                                                                                                                    |
