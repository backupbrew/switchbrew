...
| 0x184000 | 0x20    | Unknown pseudorandom data, changes every boot. All zero on 1.0.                    |
| 0x184020 | 0x8?    | Increments on every boot. Bottom 10 bits (0x3FF) are always zero. All zero on 1.0. |
