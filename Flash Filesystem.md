...
The 0x4000 bytes at offset 0xFC000 are used by ![NS](NS%20Services.md
"wikilink") and ![boot](Boot.md "wikilink") for keeping track of the
status of a system update. This area is used by the
...
| ![PRODINFO](Calibration.md "wikilink")  | 0x00004400  | 0x003FBC00  | 27                                                       | Yes (Bis key 0) | "CAL0" raw partition containing set:cal data. The official name for this partition is "CalibrationBinary".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ![PRODINFOF](Calibration.md "wikilink") | 0x00400000  | 0x00400000  | 28                                                       | Yes (Bis key 0) | FAT12 filesystem, additional calibration. The official name for this partition is "CalibrationFile".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| BCPKG2-1-Normal-Main                    | 0x00800000  | 0x00800000  | 21                                                       | No              | Raw partition where the first 0x4000 bytes (usually empty) contain the ![BootConfig](BootConfig.md "wikilink") and the remaining space contains the ![package2](Package2.md "wikilink") image from ![Title 0100000000000819](Title%20list#System%20Data%20Archives.md##System_Data_Archives "wikilink") by default. With the exFAT update installed, the ![package2](Package2.md "wikilink") image is switched to the one from ![Title 010000000000081B](Title%20list#System%20Data%20Archives.md##System_Data_Archives "wikilink"). The official name for this partition is "BootConfigAndPackage2Part1".                   |
...
| BCPKG2-3-SafeMode-Main                  | 0x01800000  | 0x00800000  | 23                                                       | No              | Raw partition where the first 0x4000 bytes (usually empty) contain the ![BootConfig](BootConfig.md "wikilink") and the remaining space contains the ![package2](Package2.md "wikilink") image from ![Title 010000000000081A](Title%20list#System%20Data%20Archives.md##System_Data_Archives "wikilink") by default. On \[4.0.0+\] and with the exFAT update installed, the ![package2](Package2.md "wikilink") image is switched to the one from ![Title 010000000000081C](Title%20list#System%20Data%20Archives.md##System_Data_Archives "wikilink"). The official name for this partition is "BootConfigAndPackage2Part3". |
...
readable with
![NCM\_services\#ReadContentIdFile](NCM%20services#ReadContentIdFile.md##ReadContentIdFile
"wikilink").

The filenames for saveimages is just "<lower-case hex u64 saveID>".
SYSTEM-partition saveIDs are specified by ![FS](Filesystem%20services.md
"wikilink") commands, while USER-partition saveIDs are determined by
FS-module internally. The high u32 of the saveID is normally either
...
| ------------------ | ------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0x8000000000000000 | fs           | saveDataIxrDb:/, saveDataIxrDbSf:/, saveDataIxrDbPr:/, saveDataIxrDbSd:/ | Contains ![imkvdb.arc](IMKV.md "wikilink") and "lastPublishedId".                                                                                                        |
...
| 0x8000000000000049 | ns           | ns\_ssversion:/                                                          | Safe System version.                                                                                                                                                     |
...
| 0x8000000000000120 | ncm          | ?                                                                        | meta/![imkvdb.arc](IMKV.md "wikilink") for system partition. Cache of data extracted from the ![CNMT](CNMT.md "wikilink") for installed firmware titles (including 816). |
| 0x8000000000000121 | ncm          | ?                                                                        | meta/![imkvdb.arc](IMKV.md "wikilink") for user partition. Cache of data extracted from the ![CNMT](CNMT.md "wikilink") for installed game, update, and DLC titles.      |
| 0x8000000000000122 |              |                                                                          |                                                                                                                                                                          |
