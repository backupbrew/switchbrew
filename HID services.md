...
| 226                     | \[5.0.0+\] [\#GetSixAxisSensorDriverStates](#GetSixAxisSensorDriverStates "wikilink")           |
...
| 234                     | \[6.0.0+\] [\#GetUniquePadDeviceTypeSetInternal](#GetUniquePadDeviceTypeSetInternal "wikilink") |
...
Takes a total of 8-bytes of input and a type-0xA output buffer, returns
a total of 8-bytes of output.

\[9.0.0+\] Now takes a total of 8-bytes of input and a type-0x6 output
buffer, returns a total of 8-bytes of output.
