...
mistake, as it generates structs with the maximum possible padding --
Nintendo probably meant to sort from high to low, but couldn't/can't
change this without breaking backwards compatibility.
