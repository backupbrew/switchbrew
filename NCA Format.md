...
| 0x206  | 0x1             | Crypto Type. Not known to be used on retail systems, with \<v3.0 at least. Normally 0. 0x2=Unknown added with [3.0.0](3.0.0.md "wikilink"). 0x4=Unknown added with [3.0.1](3.0.1.md "wikilink"). |
| 0x207  | 0x1             | Key index                                                                                                                                                                                        |
...
"Crypto Type" 0x4 is not used for *all* system non-ncatype0 content.
