...
| 0x206  | 0x1             | Crypto Type. Not known to be used on retail systems, with \<v3.0 at least. Normally 0. 2=Unknown added with [3.0.0](3.0.0.md "wikilink"), used with ncatype1(not used for ncatype0, unknown for others). |
| 0x207  | 0x1             | Key index                                                                                                                                                                                                |
...
{crypto/keydata} is used for the sections' data.
