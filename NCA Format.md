...
| 0x206  | 0x1             | Crypto Type, must be 0-2. Only used stating with [3.0.0](3.0.0.md "wikilink"). Normally 0. 2 = supported starting with [3.0.0](3.0.0.md "wikilink").                                 |
...
| 0x220  | 0x1             | Crypto-Type2. 0x3 = Unknown added with [3.0.1](3.0.1.md "wikilink").                                                                                                                 |
