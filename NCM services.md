...
| 16  | CreatePlaceholderEntryRegisteredEntryAndRegisteredDirectoryEntry           | Takes three 0x10-sized [\#NcaIDs](#NcaID "wikilink"). Creates the placeholder NCA path, renames it to the registered NCA path, and creates the registered directory NCA path. |
