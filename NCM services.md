...
| 9   | AreMetaRecordsPresent                                        | Takes a type-5 buffer containing size/0x10 [Meta Records](NCA#Meta%20records.md##Meta_records "wikilink") and returns whether all of those records are present in the database.                                                          |
