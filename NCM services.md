...
| Cmd | Name                                                     | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | Set                                                      | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), a type-5 [Content Records](CNMT#Content%20records.md##Content_records "wikilink") buffer and a u64 size.                                                                                                                                                                                                                                                                                                                                                                            |
| 1   | Get                                                      | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), a type-6 buffer to write [Content Records](CNMT#Content%20records.md##Content_records "wikilink") to and a u64 size. Returns the actual number of bytes read into the buffer. First 8 bytes of the data is header (u16 numExtraDataBytes, numContentRecords, numMetaRecords, padding). After the header is numExtraDataBytes of additional data, after which follow content records and meta records. Set takes this same data as input.                                            |
| 2   | Remove                                                   | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and removes the associated record.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 3   | GetContentIdByType                                       | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink") and a u8 [Title Type](#Title_Types "wikilink"). Returns a [\#NcaID](#NcaID "wikilink").                                                                                                                                                                                                                                                                                                                                                                                              |
| 4   | ListContentInfo                                          | Takes a type-6 buffer to write [Content Record](CNMT#Content%20records.md##Content_records "wikilink") entries to, a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and a u32 index into the Content Record entries to start copying from. Returns a u32 entries\_read.                                                                                                                                                                                                                                                                    |
| 5   | List                                                     | Takes a type-6 buffer to write [Meta Records](CNMT#Meta%20records.md##Meta_records "wikilink") to, a u32 [Title Type](#Title_Types "wikilink"), a u64 TID, a u64 TID\_LOW, and u64 TID\_HIGH. Writes into the buffer all Meta Records with low \<= record-\>title\_id \<= high, and record-\>type == type. Returns u32 numEntriesTotal, numEntriesWritten. Additionally requires record-\>title\_id == TID, if record-\>type is Application, Patch, Add-On, or Delta, otherwise, you can pass 0 for type to ignore the type and list them all in the range. |
| 6   | GetLatestContentMetaKey                                  | Takes a u64 title id, and returns the [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink") with the highest version field for that title id.                                                                                                                                                                                                                                                                                                                                                                                                      |
| 7   | [\#ListApplication](#ListApplication "wikilink")         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 8   | Has                                                      | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink") and returns whether that record is present in the database.                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 9   | HasAll                                                   | Takes a type-5 buffer containing [Meta Records](CNMT#Meta%20records.md##Meta_records "wikilink") (code assumes there are size/sizeof(meta\_record) records in the buffer), and returns whether all of those records are present in the database.                                                                                                                                                                                                                                                                                                            |
| 10  | GetSize                                                  | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and returns the size of the associated [Content Records](CNMT#Content%20records.md##Content_records "wikilink").                                                                                                                                                                                                                                                                                                                                                                    |
| 11  | GetRequiredSystemVersion                                 | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and returns u32 from ContentRecords + 16 (only if the Meta record has type Application or Patch).                                                                                                                                                                                                                                                                                                                                                                                   |
| 12  | GetPatchId                                               | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and returns the update title id for that record.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| 16  | HasContent                                               | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink") and an [\#NcaID](#NcaID "wikilink"). Returns whether the content records for that meta record contain the NcaID.                                                                                                                                                                                                                                                                                                                                                                     |
| 17  | ListContentMetaInfo                                      | Takes a type-6 [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink") output buffer, a u32 offset into that buffer, and an input [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink").                                                                                                                                                                                                                                                                                                                                                    |
| 18  | GetAttributes                                            | Takes a [Meta Record](CNMT#Meta%20records.md##Meta_records "wikilink"), and returns u8 from ContentRecords + 6.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
Takes a type-6 [Meta
Record](CNMT#Meta%20records.md##Meta_records "wikilink") output buffer,
a u32 offset into that buffer, and an input [Meta
Record](CNMT#Meta%20records.md##Meta_records "wikilink") entry. Returns
a u32 for total\_read\_entries.
