...
| 5   | GetMetaRecords                                               | Takes a type-6 buffer to write [Meta Records](NCA#Meta%20records.md##Meta_records "wikilink") to, a u32 [Title Type](#Title_Types "wikilink"), a u64 TID, a u64 TID\_LOW, and u64 TID\_HIGH. Writes into the buffer all Meta Records with low \<= record-\>title\_id \<= high, and record-\>type == type. Additionally requires record-\>title\_id == TID, if record-\>type is Application, Patch, Add-On, or Delta. |
