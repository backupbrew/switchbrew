...
| 0x2C | svcMapPhysicalMemory                                                               |                                                                               | This SVC was added in version [3.0.0](3.0.0.md "wikilink"). |
| 0x2D | svcUnmapPhysicalMemory                                                             |                                                                               | This SVC was added in version [3.0.0](3.0.0.md "wikilink"). |
| .... | ?                                                                                  | ?                                                                             | ?                                                           |
...
| ?           | 0xF0000002 | 0                     | Unknown. Uses the input handle.                                                                                                                                    |
