...
whitelist, and does a TrustZone call using [SMC](SMC.md "wikilink") Id1
...
| `0x00002013` | \[2.0.0+\] Unknown per-thread read-only memory                 | Mapped in hardcoded process (?) during [svcCreateThread](SvcCreateThread.md "wikilink").                            |
