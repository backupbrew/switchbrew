...
| Transfer Memory leak in nvservices system module                                                                    | The nvservices sysmodule does not clear most of its transfer memory prior to release.                                                                                                                                                                                                                                                                                                                                                                                                                     | The calling process can read key bits of memory, including breaking ASLR (by revealing the image base) and exposing the address of other transfer memory to set up attacks.                                                    | [6.0.0](6.0.0.md "wikilink") | [6.0.0](6.0.0.md "wikilink")                  | June 2017                     | 16 October 2018                                  | [qlutoo](User:qlutoo "wikilink") and [hexkyz](User:hexkyz "wikilink"), [daeken](User:daeken "wikilink") (independently) |
